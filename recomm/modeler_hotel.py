...
#전처리
df_raw = pd.read_csv('data/hotel_review.csv', names=['placeId','userId','score','title','review'],encoding='ms949')
...
df_raw.to_csv('data/hotel_review_pp.csv',mode='w')
df = df_raw
del df_raw
